...
struct WeatherCurrent: Decodable {
    ...
    var sunriseString: String           { return Date(timeIntervalSince1970: Double(sunrise)).formateToTime() }
    
    var sunsetString: String            { return Date(timeIntervalSince1970: Double(sunset)).formateToTime() }
    ...
    var visibilityString: String        { return String(format: "%.1f", visibility / 1000) + " km" }
